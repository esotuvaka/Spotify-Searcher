	...
	return (
		<div id="artist-card" className="mx-auto w-4/5 pb-4 lg:w-2/3">
			<div
				className={
					activeTheme === '#262626'
						? 'flex flex-col justify-between rounded-lg bg-neutral-800 shadow-md shadow-black transition-all duration-300 sm:h-96 sm:flex-row xl:h-[50vh] 2xl:h-[50vh]'
						: 'flex flex-col justify-between rounded-lg bg-white shadow-md shadow-neutral-700 transition-all duration-300 sm:h-96 sm:flex-row xl:h-[50vh] 2xl:h-[50vh]'
				}
			>
				...
				<div id="artist-image">
					<img
						...
						alt="/"
						className="w-full rounded-b-lg sm:h-96 sm:rounded-r-lg sm:rounded-bl-none xl:h-[50vh] 2xl:h-[50vh]"
					/>
				</div>
			</div>
		</div>
